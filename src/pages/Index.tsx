            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="flex flex-col lg:flex-row items-center justify-center gap-12 max-w-6xl mx-auto">
                ...
                <div className="w-full lg:w-1/2 flex justify-center">
                  <svg width="400" height="200" viewBox="0 0 974.28 376.03" className="max-w-full h-auto">
                    <defs>
                      <style>
                        {`.cls-1 { fill: #00adee; }
                        .cls-2 { fill: #fcd2b3; }
                ...
                {/* Список сервисов справа */}
                <div className="w-full lg:w-1/2 space-y-4">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Сервисы</h2>
                    <p className="text-gray-600 dark:text-gray-400">Свободные и занятые окошки</p>
                  </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start gap-4 flex-1">
                          <div className={`
                            ...
                            ${selectedNode === service.id || focusedNode === service.id
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <span className="text-xs text-gray-400 dark:text-gray-500">из 1</span>
                        </div>
                      </div>
                    </div>
                  ))}
